  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ctaVariants({ variant: buttonVariant }),
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }) => {
          if (orientation === "left") {
            return <Icon name="chevronLeft" className={cn("size-4", className)} {...props} />;
          }

          if (orientation === "right") {
            return <Icon name="chevronRight" className={cn("size-4", className)} {...props} />;
          }

          return <Icon name="chevronDown" className={cn("size-4", className)} {...props} />;
        },
